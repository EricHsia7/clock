  ...
  return {
    plugins: [
      ...
      new WorkboxPlugin.GenerateSW({
        ...
        include: [/\.js|css|png$/],
        cacheId: `clock-${generateRandomString(16)}`,
        runtimeCaching: [
          {
    ...
    output: {
      ...
      publicPath: 'https://erichsia7.github.io/clock/dist/',
      library: {
        name: 'clock',
        type: 'umd',
        umdNamedDefine: true,
      ...
      rules: [
        {
          ...
          include: [path.resolve(__dirname, 'node_modules/@erichsia7/pwdgen2/src/core'), path.resolve(__dirname, 'src')],
          use: {
            loader: 'babel-loader',
            options: {
